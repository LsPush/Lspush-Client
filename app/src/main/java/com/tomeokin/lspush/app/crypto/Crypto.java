...
public class Crypto {
    private static Log log = AppLogger.cryptoLog("Crypto");
    private static Crypto crypto;
    private static PublicKey pubKey;

    public static Crypto init(String publicKey) {
        if (crypto == null) {
    ...
    private Crypto(final String pubKey) {
        try {
            ...
            log.log(e, "Init crypto failed");
        }
    }

    private void initKey(final String pubKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    public CryptoToken encrypt(String data)
        ...
        return encrypt(data.getBytes(CharsetSupport.UTF_8));
    }
